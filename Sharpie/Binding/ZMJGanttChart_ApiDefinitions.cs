...
namespace Spreadsheet
{
	...
	interface BorderStyle
	{
		...
		BorderStyle_Enum Border_enum { get; set; }
		...
		IntPtr Constructor (BorderStyle_Enum style_enum, nfloat widith, UIColor color);
	...
	interface GridStyle
	{
		...
		GridStyle_Enum StyleEnum { get; set; }
		...
		[Export ("initWithStyle:width:color:")]
		IntPtr Constructor (GridStyle_Enum style_enum, nfloat widith, UIColor color);
		...
		GridStyle Style (GridStyle_Enum style_enum, nfloat widith, UIColor color);
	}
	...
	interface NSArray_WBGAddition
	{
		...
		[Verify (MethodToProperty)]
		NSObject[] Wbg_arrayByRemovingDuplicate { get; }
		...
		[Verify (MethodToProperty)]
		NSObject[] Wbg_arrayByReverse { get; }
	...
	interface NSDictionary_WBGAdd
	{
		...
		NSDictionary<NSObject, NSObject> Wbg_dictionaryByRemovingNSNull { get; }
	}
	...
	[BaseType (typeof(NSObject))]
	interface ReusableCollection : INSFastEnumeration
	{
	...
	interface SpreadsheetViewDataSource
	{
		...
		nfloat SpreadsheetView (SpreadsheetView spreadsheetView, nint column);
		...
		nfloat SpreadsheetView (SpreadsheetView spreadsheetView, nint row);
		...
		ZMJCell SpreadsheetView (SpreadsheetView spreadsheetView, NSIndexPath indexPath);
	...
	interface SpreadsheetViewDelegate
	{
		...
		bool SpreadsheetView (SpreadsheetView spreadsheetView, NSIndexPath indexPath);
		...
		void SpreadsheetView (SpreadsheetView spreadsheetView, NSIndexPath indexPath);
	...
	interface SpreadsheetView
	{
		...
		SpreadsheetViewDataSource DataSource { get; set; }
	...
	interface SpreadsheetView_CirclularScrolling
	{
		...
		[Verify (MethodToProperty)]
		CircularScrollScalingFactor DetermineCircularScrollScalingFactor { get; }
	...
	interface SpreadsheetView_UIScrollView
	{
		...
		// @property (readonly, assign, nonatomic) UIEdgeInsets adjustedContentInset;
	...
	{
		// extern double ZMJGanttChartVersionNumber;
		[Field ("ZMJGanttChartVersionNumber", "__Internal")]
		double ZMJGanttChartVersionNumber { get; }

		// extern const unsigned char [] ZMJGanttChartVersionString;
		[Field ("ZMJGanttChartVersionString", "__Internal")]
		byte[] ZMJGanttChartVersionString { get; }
	}
}
